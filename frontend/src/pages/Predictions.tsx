...
export default function Predictions() {
  ...
  const [charts, setCharts] = useState([40, 70, 45, 90, 65, 30, 85]);
    ...
    <div className="space-y-6 h-full flex flex-col">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Machine learning forecasts for potential future incidents.</p>
        </div>
        {isOnline && (
